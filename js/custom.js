...
function enquiriese() {
  let emiz = "adminkkkkkproximater000com"
  let elink = "elinkb"
  document.getElementById(elink).href =
    "mailto:" +
    emiz.replace("kkkkk", "@").replace("000", ".").replace("666", ".") +
    "?subject=Proximater Assistance"
}
...
$(document).ready(function () {
  ...
  $(".video-popup").magnificPopup(
    {
      items: [
        {
          id: '941916041',
          src: 'https://player.vimeo.com/video/941916041?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
  ...
  $(".newsletter-form").ajaxChimp({
    language: "cm",
    url: "https://proximater.us14.list-manage.com/subscribe/post?u=9721bfdd37f2f515cc0e6f631&amp;id=97fc0baacd&amp;f_id=000996e1f0",
  ...
  $.ajaxChimp.translations.cm = {
    submit: "Submitting...",
    0: "Thanks! We will keep you posted with updates as they happen.",
